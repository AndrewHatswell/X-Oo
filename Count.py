...
def piece_count(tile, number_of_pieces):
    if tile.player == 1:
...
def out_of_pieces(tile, number_of_pieces):
    if tile.player == 1:
        if int(tile.piece_type) == 1:
            ...
            if number_of_pieces.adjacent_count_p1 != 0:
                return True
            else:
                print "You don't have any o's left"
                return False
        elif int(tile.piece_type) == 4:
            if number_of_pieces.nonAdjacent_count_p1 != 0:
                return True
            else:
                print "You don't have any O's left"
                return False
    ...
    if tile.player == 2:
        if int(tile.piece_type) == 1:
            ...
            if number_of_pieces.adjacent_count_p2 != 0:
                return True
            else:
                print "You don't have any o's left"
                return False
        elif int(tile.piece_type) == 4:
            if number_of_pieces.nonAdjacent_count_p2 != 0:
                return True
            else:
                print "You don't have any O's left"
                return False
